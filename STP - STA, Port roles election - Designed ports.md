Una vez calculado el Root Port en los switches Non-Root, se debe calcular cuales interfaces quedan en rol _**Designated**_ y cuales quedan en _**Non-designated**_.
