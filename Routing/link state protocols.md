...
Los link state protocol actualizan la información de enrutamiento cada 30 minutos (en [distance vector protocols](distance%20vector%20protocols.md) eran cada 30 segundos en promedio, [RIPv2](RIP/RIPv2.md) p. ej.), no existe un temporizador con intervalos regulares como [holddown timers](holddown%20timers.md). 
