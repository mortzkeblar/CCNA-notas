...
- Si existe una dirección Loopback, será elegida por encima de cualquier otra dirección IP.
	- Si existen varias direcciones Loopback, se elige la que tiene la [IP](../../labs/NetWarriors/IP.md) más alta.
- Si no existe una dirección Loopback, se elige a la [IP](../../labs/NetWarriors/IP.md) más alta del router.
