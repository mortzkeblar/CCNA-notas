> STA es un algoritmo que permite eliminar los caminos ciclicos de forma lógica. Quedando como respaldo los caminos físicos en caso de que los primeros fallen.
